def fun(func): #reference of f function will come to func variable
    def wrapper(*args,**kwargs): 
        print('started')
        a=func(*args,**kwargs) #calling the f function because func contain the reference of f function therefore the control will move to the reference of f function and execute that block first
...
#therefore pass args and **kwargs to both of these function which allow us to give as many as argument you want to passes